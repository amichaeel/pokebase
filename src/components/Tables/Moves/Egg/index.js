...
const EggMovesTable = ({ pokemonData }) => {
  ...
  return (
    <div className="w-full">
      {loading ? (
        ...
        <div className="text-center">{capitalize(pokemonData.name)} cannot learn any moves by egg moves.</div>
      ) : (
