      ...
      <table className="table-auto border-collapse w-full">
        <thead>
          <tr>
            ...
            >
              <div className='flex items-center justify-between '>
                <span className='uppercase text-left text-xs font-medium tracking-wider'>Type</span>
                <ChevronUpDownIcon className='size-4' />
              </div>
            </th>
            ...
            >
              <div className='flex items-center justify-between'>
                <span className='uppercase text-left text-xs font-medium tracking-wider'>Cat.</span>
                <ChevronUpDownIcon className='size-4' />
              </div>
            </th>
            ...
            >
              <div className='flex items-center justify-between '>
                <span className='uppercase text-left text-xs font-medium tracking-wider'>Pow.</span>
                <ChevronUpDownIcon className='size-4' />
              </div>
            </th>
            ...
            >
              <div className='flex items-center justify-between '>
                <span className='uppercase text-left text-xs font-medium tracking-wider'>Acc.</span>
                <ChevronUpDownIcon className='size-4' />
              </div>
            </th>
            ...
            >
              <div className='flex items-center justify-between '>
                <span className='uppercase text-left text-xs font-medium tracking-wider'>PP</span>
                <ChevronUpDownIcon className='size-4' />
              </div>
            </th>
            ...
            >
              <div className='flex items-center justify-between '>
                <span className='uppercase text-left text-xs font-medium tracking-wider'>Prob. (%)</span>
                <ChevronUpDownIcon className='size-4' />
              </div>
            </th>
          </tr>
