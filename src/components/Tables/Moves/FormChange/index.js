        ...
        pokemonData.moves
          .filter((move) =>
            move.version_group_details.some(
              (detail) => detail.move_learn_method.name === "form-change",
            ),
          )
          .map(async (move) => {
            ...
            const formChangeDetail = move.version_group_details.find(
              (detail) => detail.move_learn_method.name === "form-change",
            );
    ...
    <div className="w-full">
      {loading ? (
        ...
        <div className="text-center">
          {capitalize(pokemonData.name)} cannot learn any moves by form change.
        </div>
      ) : (
            ...
            <thead className="sticky-header">
              <tr className="hover:*:bg-base-100 hover:*:cursor-pointer">
                <th
                  ...
                  className={`py-2 ${sortConfig.key === "form" ? "bg-base-100" : ""}`}
                >
