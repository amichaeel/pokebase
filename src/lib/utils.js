...
export const versionGroups = [
  ...
  { name: "lets-go-pikachu-lets-go-eevee", fullName: "Let's Go, Pikachu!/Let's Go, Eevee!" },
  ...
  { name: "brilliant-diamond-and-shining-pearl", fullName: "Brilliant Diamond/Shining Pearl" },
